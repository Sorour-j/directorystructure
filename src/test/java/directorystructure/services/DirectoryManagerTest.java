...
public class DirectoryManagerTest {
	...
	public void buildTreeSuccess() {
		assertEquals("name = folder1, type = Directory, size = 40\n"
				+ " name = folder2, type = Directory, size = 40\n"
				+ "  name = file1, type = File, size = 20, classification = Secret, checksum = 42\n"
				+ "  name = file3, type = File, size = 20, classification = Top Secret, checksum = 42", DirectoryManager.buildTree(structure));
	}
